...
const Mapa = () => {
    return (
        <div className="relative h-[550px] w-full px-20 py-10 flex gap-8 bg-white overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-300">
            <iframe
                ...
                className="w-4/6 h-full m-auto border-0 rounded-lg"
                allowFullScreen=""
                loading="lazy"
                title="Mapa del Camping Municipal de Cachi"
            ></iframe>

            <div className="w-2/6 py-10 flex flex-col justify-center space-y-6">
                ...
                {/* Título y texto para "¿Cómo llego al camping?" */}
                <div className="space-y-4">
                    <h3 className="text-2xl font-bold text-gray-800 flex items-center">
